    ...
    <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="m-auto text-center h-auto">
            ...
            <svg class="mb-6 w-full" width="490" height="350" viewBox="0 0 490 350" fill="none"
                ...
                <circle cx="245" cy="175" r="174" stroke="#F4F4FA" stroke-width="2"
                    stroke-linecap="round" />
                <circle cx="245" cy="175" r="110" fill="white" stroke="#F4F4FA" stroke-width="40" />
                <g filter="url(#filter0_d)">
                    <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="375" y="125"
                ...
                <g filter="url(#filter1_d)">
                    <mask id="mask1" mask-type="alpha" maskUnits="userSpaceOnUse" x="15" y="126"
                        width="100" height="100">
                ...
                <line x1="116" y1="175" x2="374" y2="175" stroke="#22B07D" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="12 12" />
                ...
                <path
                    ...
                    fill="white" />
                <defs>
                    <filter id="filter0_d" x="360" y="110" width="130" height="130"
                        ...
                        <feColorMatrix type="matrix"
                            values="0 0 0 0 0.3625 0 0 0 0 0.3625 0 0 0 0 0.3625 0 0 0 0.16 0" />
                    ...
                    <filter id="filter1_d" x="0" y="111" width="130" height="130"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                    ...
                    <image id="image0" width="500" height="500"
                        xlink:href="https://randomuser.me/api/portraits/men/40.jpg" />
                    <!-- Gambar kanan -->
                    <image id="image1" width="500" height="500"
                        xlink:href="https://randomuser.me/api/portraits/men/97.jpg" />
                </defs>
            </svg>
            ...
            <a href="http://wa.me/62895383254673"
                class="bg-serv-button text-white text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">
                Continue to Chat
            </a>
            <br>
            <a href="{{ route('index') }}"
                class="bg-serv-services-bg text-serv-bg text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">
                Back to Home
            </a>
