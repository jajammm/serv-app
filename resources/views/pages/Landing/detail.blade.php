                ...
                <div class="content">
                    <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                        ...
                        <nav class="my-8" aria-label="navigation">
                            ...
                            <a class="inline-block px-8 py-2 my-2 mr-2 font-medium rounded-xl"
                                :class="{
                                    'bg-serv-bg text-white': tab === 'seller',
                                    'bg-serv-services-bg text-serv-bg': tab !==
                                        'seller'
                                }"
                                @click.prevent="tab = 'seller'; window.location.hash = 'seller'" href="#">About The
                                Seller</a>
                            <a class="inline-block px-8 py-2 my-2 mr-2 font-medium rounded-xl"
                                :class="{
                                    'bg-serv-bg text-white': tab ===
                        ...
                        <div x-show.transition.duration.500ms="tab === 'description'" class="leading-8 text-md">
                            ...
                            <div class="mt-4 mb-8 content-description">
                                <p>
                                    I will design wordpress ecommerce modules, professional website for you using WordPress!
                                    With this Services
                                </p>
                            </div>
                            ...
                            <p class="mb-4">
                                If you only require modifications made to an existing WordPress website that you have, I
                                have a different Services for that, which you can find on my profile!
                            </p>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'seller'" class="leading-8 text-md">
                            ...
                            <div class="grid md:grid-cols-12">
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    <div class="flex items-center space-x-4">
                                        <img src="{{ url('https://avatars2.githubusercontent.com/u/1490347?s=460&u=39d7a6b9bc030244e2c509119e5f64eabb2b1727&v=4') }}"
                            ...
                            <div class="mb-8 skills">
                                <span class="inline-block px-3 py-1 mr-2 rounded bg-serv-services-bg">Web
                                    Development</span>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'reviews'">
                            <h2 class="mb-4 text-xl font-semibold"><span class="text-serv-button">210</span> Happy Clients
                            </h2>
                    ...
                    <div class="flex items-center px-2 py-3 mx-4 mt-4 border rounded-full border-serv-testimonial-border">
                        ...
                        <div class="flex-1 text-sm font-medium text-center">
                            <svg class="inline" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M7 21.5L4.14142 18.6414C4.06332 18.5633 4.06332 18.4367 4.14142 18.3586L7 15.5"
                                    stroke="#082431" stroke-width="1.5" stroke-linecap="round" />
