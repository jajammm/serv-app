                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_service as $advantage_item)
                                                <input placeholder="Keunggulan Service" type="text"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option>Butuh Berapa hari service kamu selesai?</option>
                                                <option value="2"
                                                    {{ $service->revision_limit == '2' ? 'selected' : '' }}>2 Revisi
                                                </option>
                                                <option value="5"
                                                    {{ $service->revision_limit == '5' ? 'selected' : '' }}>4 Revisi
                                                </option>
                                                <option value="7"
                                                    {{ $service->revision_limit == '7' ? 'selected' : '' }}>8 Revisi
                                                </option>
                                                <option value="10"
                                                    {{ $service->revision_limit == '10' ? 'selected' : '' }}>16 Revisi
                                                </option>
                                                <option value="12"
                                                    {{ $service->revision_limit == '12' ? 'selected' : '' }}>32 Revisi
                                                </option>
                                            </select>
                                        </div>
                                                ...
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-2">
                                                        <img src="{{ url(Storage::url($thumbnail_item->thumbnail)) }}"
                                                            alt="thumbnail" class="inline object-cover w-20 h-20 rounded"
                                                            for="choose">

                                                        <input placeholder="Thumbnail" type="file"
                                                            name="{{ 'thumbnails[' . $thumbnail_item->id . ']' }}"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_user as $advantage_user_item)
                                                <input placeholder="Keunggulan Kamu" type="text"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                <input placeholder="Tagline" type="text"
                                                    name="{{ 'taglines[' . $tagline_item->id . ']' }}" id="taglines"
                                                    autocomplete="taglines"
                                                    class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan Service" type="text" name="advantage_user[]" id="advantage_user" autocomplete="advantage_user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan Kamu" type="text" name="advantage_user[]" id="advantage_user" autocomplete="advantage_user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Thumbnail" type="file" name="thumbnail[]" id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
