                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            <div class="flex items-center mt-1">
                                                ...
                                                @if (auth()->user()->detail_user()->first()->photo != null)
                                                    <img src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}"
                                                        alt="photo profile" class="rounded-full">
                                                @else
                                                    <span
                                                ...
                                                <input type="file" accept="image/*" id="choose" name="photo">
                                            ...
                                            @if ($errors->has('photo'))
                                                <p class="text-red-500 mb-5 text-sm">{{ $errors->first('photo') }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="service-name" id="service-name"
                                                autocomplete="service-name"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                rows="4">I am a web developer and web designer. I have an Associate Degree in Software and Web Development, and I have much experience in programming languages, such as HTML5, CSS3, PHP, Javascript and PHP. I can use Bootstrap and WordPress.
